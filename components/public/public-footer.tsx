...
export function PublicFooter() {
  return (
    <footer className="relative z-10 py-6 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center text-[10px] text-white/70 tracking-widest uppercase border-t border-white/5">
